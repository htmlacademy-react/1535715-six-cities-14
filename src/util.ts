...
export const sortingCards: sortingObject = {
  ...
  [SortType.PRICE_LTH]: (storeOffers) =>
    [...storeOffers].sort((a, b) => a.price - b.price),
  [SortType.PRICE_HTL]: (storeOffers) =>
    [...storeOffers].sort((a, b) => b.price - a.price),
  [SortType.TOP_RATED]: (storeOffers) =>
    [...storeOffers].sort((a, b) => b.rating - a.rating),
};
